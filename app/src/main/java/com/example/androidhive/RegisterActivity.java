...
public class RegisterActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        inputDOB = (DatePicker) findViewById(R.id.datePicker);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                String dob = inputDOB.getDayOfMonth()+"/"+inputDOB.getMonth()+"/"+inputDOB.getYear();
     ...
     * */
    private void registerUser(final String username, final String dob, final String email,
        ...
        strReq = new StringRequest(Method.POST,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    boolean value_obt = jObj.getBoolean("pass");
                    Log.d("check json",Boolean.toString(value_obt));
                    if (!error) {
...
//                        String uid = jObj.getString("uid");
                        ...
                        db.addUser(user_id, username, dob, email, created_at);
